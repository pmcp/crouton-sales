...
import { getAllPosProductOptions, getPosProductOptionsByIds } from '../../../../database/queries'
...
export default defineEventHandler(async (event) => {
  ...
  if (query.ids) {
    ...
    return await getPosProductOptionsByIds(team.id, ids)
  }

  return await getAllPosProductOptions(team.id)
})