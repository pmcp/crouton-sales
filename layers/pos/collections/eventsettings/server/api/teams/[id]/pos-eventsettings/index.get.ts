...
import { getAllPosEventSettings, getPosEventSettingsByIds } from '../../../../database/queries'
...
export default defineEventHandler(async (event) => {
  ...
  if (query.ids) {
    ...
    return await getPosEventSettingsByIds(team.id, ids)
  }

  return await getAllPosEventSettings(team.id)
})